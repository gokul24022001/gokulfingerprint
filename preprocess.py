...
def writeToFile(data, indices, height, width):
    ...
    cv2.imwrite('data/die.jpg', foreground_data.reshape([height, width, -1]))
    ...
    cv2.imwrite('data/mask.png', mask_data.reshape([height, width, -1]))
    print("succeed in saving mask image into \"./data/mask.png\"")
